...
// Shared course features (live sessions + CV + exams)
...
async function main() {
  ...
  // Delete existing certificates, payments, enrollments, courses
  ...
  for (const course of courses) {
    ...
    console.log(`  ✓ ${course.title} (${course.lessons} دروس، المدة ${course.duration})`)
  }
  console.log(`\n✅ تمت زراعة ${courses.length} كورس بنجاح`)
  console.log(`📢 قناة تلجرام: ${TELEGRAM}`)
}
